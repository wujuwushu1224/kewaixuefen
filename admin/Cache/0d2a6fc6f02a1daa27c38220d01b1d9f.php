...
background="/Public/images/u_bg.gif" height="34"><span id="posi_span">你当前的位置：<span style="COLOR: #333333; TEXT-INDENT: 10px">[选修课模块]-[课程学分管理]</span></span>
</td>
          <td style="color: rgb(51, 51, 51); text-indent: 10px;" 
        ...
        <tbody><tr>
          <td><table style="margin-top: 10px;" bordercolorlight="#000000" bordercolordark="#FFFFFF" align="center" bgcolor="C5D6E5" border="0" cellpadding="0" cellspacing="1" width="100%">
            <tbody><tr bgcolor="F1F1F1">
              <td bgcolor="F7FCFF" height="30" width="75"><p align="center">编号</p></td>
              <td bgcolor="F7FCFF" height="30" width="620" align="center">课程名称</td>
              <td align="center" bgcolor="F7FCFF" width="492">教师</td>
              </tr>
			...
			<?php if(is_array($list)): ?><?php $i = 0;?><?php $__LIST__ = $list?><?php if( count($__LIST__)==0 ) : echo "" ; ?><?php else: ?><?php foreach($__LIST__ as $key=>$infols): ?><?php ++$i;?><?php $mod = (($i % 2 )==0)?><tr style="" onMouseOver="this.style.backgroundColor='#FCF9EA'" onMouseOut="this.style.backgroundColor=''" bgcolor="#ffffff">
              ...
              <td height="30" align="center"  ><a href="/index.php/Choice/mlist_a/id/<?php echo (is_array($infols)?$infols["id"]:$infols->id); ?>"><?php echo (strip_tags(is_array($infols)?$infols["kc"]:$infols->kc)); ?></a></td>
              <td align="center" height="30" ><?php echo ($infols['truename']['truename']); ?></td>
