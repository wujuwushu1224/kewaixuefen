...
cellspacing="1" width="100%">
        <tbody><tr>
          <td height="34" 
background="/Public/images/u_bg.gif" style="color: rgb(51, 51, 51); text-indent: 10px;"><span id="posi_span">你当前的位置：[必选课模块]-[学分管理]</span>
</td>
          </tr>
      </tbody></table>
        ...
        <tbody><tr>
          <td><table style="margin-top: 10px;" bordercolorlight="#000000" bordercolordark="#FFFFFF" align="center" bgcolor="C5D6E5" border="0" cellpadding="0" cellspacing="1" width="100%">
            <tbody><tr bgcolor="F1F1F1">
              <td bgcolor="F7FCFF" height="30" width="46"><p align="center">编号</p></td>
              <td bgcolor="F7FCFF" height="30" width="405" align="center">姓名</td>
              <td bgcolor="F7FCFF" height="30" width="396" align="center">学号</td>
              <td align="center" bgcolor="F7FCFF" width="237">得分</td>
              <td bgcolor="F7FCFF" width="101"><p align="center">管理操作</p></td>
              </tr>
			...
			<?php if(is_array($list)): ?><?php $i = 0;?><?php $__LIST__ = $list?><?php if( count($__LIST__)==0 ) : echo "" ; ?><?php else: ?><?php foreach($__LIST__ as $key=>$infols): ?><?php ++$i;?><?php $mod = (($i % 2 )==0)?><tr style="" onMouseOver="this.style.backgroundColor='#FCF9EA'" onMouseOut="this.style.backgroundColor=''" bgcolor="#ffffff">
              ...
              <td height="30" ><?php if($role != 3): ?><p align="center"><a href="/index.php/Required/mEdit/id/<?php echo (is_array($infols)?$infols["id"]:$infols->id); ?>"><font color="green">评分</font></a></p><?php endif; ?></td>
