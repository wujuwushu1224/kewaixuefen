...
{//类定义开始
	...
	// 分页显示定制
    protected $config   =	array('prev'=>'&lsaquo;&lsaquo;','next'=>'&rsaquo;&rsaquo;','first'=>'1 ...','last'=>'');
    ...
    public function show($isArray=false){
        ...
        if ($upRow>0){
            $upPage="<a href='".$url."&".C('VAR_PAGE')."=$upRow' class='prev'>".$this->config['prev']."</a>";
        }else{
            $upPage="";
        }
        ...
        if($nowCoolPage == 1){
            ...
            $theFirst = "<a href='".$url."&".C('VAR_PAGE')."=1' class='first' >".$this->config['first']."</a>";
        }
        if($nowCoolPage == $this->coolPages){
            ...
            $theEnd = "<a href='".$url."&".C('VAR_PAGE')."=$theEndRow' class='last' >".$this->config['last']."</a>";
        }
        // 1 2 3 4 5
        $linkPage = "";
